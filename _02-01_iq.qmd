...
# footnotes
fn_standard_score <- gt::md("Score = Standard score (Mean = 100 [50th‰], SD ± 15 [16th‰, 84th‰])")
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [_Premorbid Ability_ represents an estimate of the individual’s intellectual functioning prior to the onset of any known or suspected brain disease or dysfunction. _Neurocognitive Index_ reflects overall cognitive capacity, including verbal and nonverbal reasoning, problem-solving, and learning new information. Scores are presented as z-scores, where the average is 0.0 with a standard deviation of 1.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
