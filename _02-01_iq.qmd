...
grp_iq <- list(
  standard_score = c("Composite Scores", "Test of Premorbid Functioning", "WAIS-IV", "WAIS-4", "WASI-2", "WISC-5", "WISC-V", "WRAT-5", "KTEA-3", "NAB", "NAB-S", "RBANS", "WPPSI-IV", "WAIS-V", "WRAT5"),
  scaled_score = c("WAIS-5", "WISC-5", "NEPSY-2", "D-KEFS", "WPPSI-IV", "CELF-5", "RBANS")
)
# wais5 taken out
...
bwu::tbl_gt(
  ...
  grp_scaled_score = grp_iq[["scaled_score"]],
  dynamic_grp = grp_iq,
  multiline = multiline
)
```
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [_Premorbid Ability_ represents an estimate of the individual's intellectual functioning prior to the onset of any known or suspected brain disease or dysfunction. _General Ability_ reflects overall cognitive capacity, including verbal and nonverbal reasoning, problem-solving, and learning new information. Scores are presented as z-scores, where the average is 0 with a standard deviation of 1.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
...
<!-- _Neurocognitive Index_ provides a comprehensive measure of cognitive functioning. This index is derived from the performance across five cognitive domains: _Attention_ Assesses the ability to focus, sustain concentration, and process information; _Language_ Evaluates verbal communication skills, including naming, comprehension, and verbal fluency; _Memory_ Measures both immediate and delayed recall of verbal and visual information; _Spatial_ Assesses visuospatial skills, including perception, construction, and orientation; _Executive Functions_ Evaluates higher-order cognitive abilities such as planning, problem-solving, and mental flexibility. #footnote[In the figures presented here and below, scores have been converted to _z_-scores, where an average score is 0.0 and the standard deviation is 1.0. Any scores below the −1.0 ticks are moderately concerning. Scores at or beyond the −2.0 ticks are clinically significant and a cause for greater concern. -->
