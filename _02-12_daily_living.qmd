...
# daily_living <- vroom::vroom("neuropsych.csv")
...
#| include: false
#| fig-cap: "daily_living and language functioning refers to the ability to access and apply acquired word knowledge, to daily_livingize meaningful concepts, to understand complex multistep instructions, to think about daily_living information, and to express oneself using words."
...
colors <- NULL
return_plot <- TRUE
filename <- "fig_daily_living_narrow.svg"

# variables to plot
x <- data_daily_living$z_mean_narrow
y <- data_daily_living$narrow
